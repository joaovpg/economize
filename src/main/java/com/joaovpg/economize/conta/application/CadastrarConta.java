...
public class CadastrarConta {
    ...
    public CadastrarConta(UsuarioRepository usuarioRepository, ContaFinanceiraRepository contaRepository) {
    ...
    public ContaResultado executar(Comando comando) {
        ...
        var dataSaldoInicial = ContaValidation.dataSaldoInicial(comando.dataSaldoInicial(),
                LocalDate.now(ZoneId.of(usuario.getTimezone())));
    ...
    public record Comando(UUID usuarioId, String nome, String moeda, BigDecimal saldoInicial,
